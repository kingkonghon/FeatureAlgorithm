...
def calFull():
    ...
    data0 = sql.read_sql("select `code`,date,close from %s " % sourceStockQuoteTableName, con_quant)
    hs300 = sql.read_sql("select date,close from %s " % sourceIndexQuoteTableName, con_quant)
