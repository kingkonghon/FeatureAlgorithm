...
from DataUpdate.updateStockFundamentalTushare import airflowCallable as updateDataStockFundamentalTushare
...
from Derivatives.calStockFeatures import airflowCallableRankingArea as calStockFeatureRankingArea, \
    ...
    airflowCallableStockFundamentalTushare as calStockFundamentalTushare
...
# UTC time
dag = DAG('evening_dag', catchup=False, schedule_interval='0 21 * * *', default_args=default_args)
...
t_stock_tushare_fundamental = PythonOperator(
    task_id='data_stock_fundamental_tushare',
    python_callable=updateDataStockFundamentalTushare,
    dag=dag)
...
# boundry tushare, derivative data ==
data_boundary_tushare = DummyOperator(task_id='data_boundary_tushare_evening', dag=dag)
data_boundary_tushare.set_upstream(t_stock_tushare_fundamental)

t_stock_feature_fundamental_tushare = PythonOperator(
    task_id='feature_stock_feature_fundamental_tushare',
    python_callable=calStockFundamentalTushare,
    dag=dag)

data_boundary_tushare.set_downstream(t_stock_feature_fundamental_tushare)