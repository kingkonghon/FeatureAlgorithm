...
# ======= dag =======
# UTC time
dag = DAG('morning_dag', catchup=False, schedule_interval='45 22 * * *', default_args=default_args)
...
data_boundary.set_downstream([t_us_index_quote, t_stock_industry, t_crude_oil])
