...
# ========= dag =========
# UTC time
dag = DAG('afternoon_dag', catchup=False, schedule_interval='10 9 * * *', default_args=default_args)
...
data_boundary.set_upstream([t_stock_for_adj_quote, t_stock_description, t_stock_index, t_stock_fundamental, t_fund_index])
...
data_boundary.set_downstream([t_stock_technical, t_stock_beta, t_stock_value, t_stock_daynum, t_HS300_technical,
                              t_area_index_for_adj_quote, t_industry_index_for_adj_quote, t_fund_index_technical])
...
data_boundary2.set_downstream([t_stock_index_technical])
