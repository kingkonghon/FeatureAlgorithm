from backtestFrameworkConThreshold import BacktestingClass
import numpy as np
import pandas as pd
import time
...
def strategy(BT_ins):
    ...
    if len(position) < max_position_num:
        ...
        # tmp_threshold = BT_ins.getTodayThreshold()
        tmp_threshold = 0.95
        target_predition = target_predition.loc[target_predition[target_label] > tmp_threshold]
