...
from calStockIndexRiseFallInterval import calFull as loadY
...
if __name__ == '__main__':
    ...
    for tmp_y in Years:
        for tmp_s in Seasons:
            ...
            # train and test
            tmp_prediction, tmp_prsc = train_and_test(tot_Y, training_start_date, training_end_date, testing_start_date, testing_end_date,
                            folder_path)
