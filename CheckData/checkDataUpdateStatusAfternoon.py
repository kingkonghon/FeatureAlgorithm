...
from tableConfigAfternoon import tableConfig, tableDirection
from generalCheckDataUpdateFunctions import sendErrorByEmail, checkTodayAllTableRecordNum
from specialCheckDataUpdate import specialRecordCheckAfternoon
...
if __name__ == '__main__':
    ...
    error_tables.extend( specialRecordCheckAfternoon() )
